...
var tonConnectSdkVersion = "3.3.0-beta.2";
...
function validateConnectAdditionalRequest(data) {
  ...
  if (data.tonProof !== void 0 && !isValidString(data.tonProof)) {
...
var tonConnectUiVersion = "2.3.0-beta.2";
